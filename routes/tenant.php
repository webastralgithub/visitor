...
Route::middleware([
    ...
    Route::middleware(['auth'])->group(function() {
        ...
        Route::post('/leads-export', [LeadController::class, 'exportLeads'])->name('exportLeads');
        Route::post('/leads-import', [LeadController::class, 'importLeads'])->name('importLeads');
    ...
    Route::get('card', [PaymentController::class, 'paymentCard'])->name('paymentCard');
